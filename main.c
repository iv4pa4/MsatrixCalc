...
void multiplyByScalar(int rows, int columns,int userMatrix[rows][columns], int result[rows][columns], int scalar) {
...
void divideByScalar(int rows, int columns,int userMatrix[rows][columns], int result[rows][columns], int scalar) {
    if(scalar==0){
...
int main(void) {
	...
	multiplyByScalar(3, 5, mMmatrix,result,  5);
	//printMatrix(3, 5, mMmatrix);
	//divideByScalar(3, 5, mMmatrix, result, 6);
	printMatrix(3, 5, result);
